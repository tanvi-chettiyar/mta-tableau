...
4. **Do bad months hit both platforms together?** — Quilt (Sheet C, **broadened from Signal/Track to all categories 2026-06-11**) shows the bright cells *don't* line up between rows. Each platform has its own bad months: 1/2/3 spikes when A/C/E is calm, and the reverse (e.g. 2024 Jan: 1/2/3=21 vs A/C/E=7; 2023 Oct: 1/2/3=16 vs A/C/E=5; 2023 May: 1/2/3=6 vs A/C/E=12). But 1/2/3 carries more events in most cells overall (annual totals 103 vs 86, 96 vs 88, 139 vs 107). Independent failure patterns, plus a heavier total load on 1/2/3, yet still the better reliability record — strong signal that the advantage is operational, not infrastructural.
5. **Why does it exist?** — Cause Ladder shows Persons on Trackbed, Signals, and Track lead on both platforms. **1/2/3 actually carries *more* incidents than A/C/E in each of the top-3 categories** — a heavier infrastructure load — yet still delivers better reliability. The gap is a service-frequency / recovery-operations story (Sheet 4). Sheet 4a (cause-side trajectory, added 2026-05-28) extends this from category mix to total incident volume across all categories year-over-year, and reveals **both platforms absorbed ~40% more incidents from 2022 to 2024** (1/2/3: 87 → 124; A/C/E: 74 → 101) with 1/2/3 carrying more every year (+13, +6, +23 incident-event gap). So the convergence is unambiguously a recovery-operations story, not a prevention one — A/C/E is getting better at handling a rising load, not avoiding incidents. The gap is closing because A/C/E is improving, not because 1/2/3 is degrading — best-case operations gain, not a calming system.
...
| 2 | Incidents over time × platform | Grouped bar chart per month (MONTH outer, Line Group inner — side-by-side, not stacked; revised 2026-06-02 per Data School R3 feedback that stacking made individual platform heights hard to read) | Is the gap real, or just an average that hides bad months? |
...
| C | Monthly Incident Pattern quilt — **broadened from Signal/Track to all categories 2026-06-11** (filter `Category IN (Signals, Track)` removed; Color/Label measure swapped from `Signal+Track Incidents` to `Real Inc`) | Highlight table (C-1/C-2 stacked, per-platform palette) | Do bad months hit both platforms together? |
